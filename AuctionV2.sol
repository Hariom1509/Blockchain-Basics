...
contract Auction {
   ...
   //Structure to hold the details of a persons
    ...
    function Auction() public payable{    //constructor
        ...
        // In the constructor,"msg.sender" is the address of the owner
    ...
    function register() public payable{
        ...
        //Here the bidders[bidderCount].addr should be initialized with address of the registrant.*/
    ...
    function bid(uint _itemId, uint _count) public payable{
        ...
        */
        ...
        /*
            Implement the three conditions below.
        ...
        */
        ...
        /* Decrement the remainingTokens by the number of tokens bid and store the value in balance variable.
    ...
    // Create a modifier named "onlyOwner" to ensure that only owner is allowed to reveal winners
    ...
    function revealWinners() public onlyOwner{
        ...
        for (uint id = 0; id < 3; id++) {
            ...
            /* Assign the winners.
           " bidders[winnerId] " will give you the person object with the winnerId.
