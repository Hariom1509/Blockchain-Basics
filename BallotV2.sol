...
contract Ballot {
    ...
    enum Stage {Init,Reg, Vote, Done} ///Initially init is 0,reg is 1,vote is 2,done is 3
    Stage public stage = Stage.Init;
    
    address chairperson;  ///only chairperson can register other voters
    mapping(address => Voter) voters;
    Proposal[] proposals; ///an array of proposals
